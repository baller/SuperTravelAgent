...
export function NotebookHero() {
  return (
    <svg
      ...
      viewBox="0 0 620 470"
      role="img"
      aria-label="打开的旅行手帐，路线穿过苏州园林、桥和火车"
    >
      ...
      <text x="104" y="143" fill="#2f332f" fontSize="34" fontWeight="600" fontFamily="serif">苏州三日</text>
      <text x="107" y="172" fill="#5e655e" fontSize="15">OCT. 02 — 04 · 和妈妈</text>
      ...
      <text x="372" y="176" fill="#6f4508" fontSize="16" fontWeight="600">慢一点，才看得见</text>
      <circle cx="523" cy="137" r="34" fill="none" stroke="#c95f4c" strokeWidth="3" strokeDasharray="4 5" />
      <text x="499" y="142" fill="#c95f4c" fontSize="13" fontWeight="700">SUZHOU</text>
